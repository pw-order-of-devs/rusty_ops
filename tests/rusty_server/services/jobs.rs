...
async fn get_all_paged_test() {
    ...
    let _ = db_client.create("jobs", &Job {
        id: "uuid".to_string(),
...
async fn create_test() {
    ...
    let _ = db_client.create("projects", &Project {
        id: "07fa1b63-1b4b-46a2-8a30-d80440bf6bc3".to_string(),
        name: "sample".to_string(),
        url: None,
        group_id: None,
    }).await;
    let result = service::create(&db_client, RegisterJob {
        name: "sample".to_string(),
        description: None,
        template: "c3RhZ2VzOgogICB0ZXN0OgogICAgICBzY3JpcHQ6CiAgICAgICAgLSBlY2hvICJoZWxsbyI".to_string(),
